...
<head>
  ...
  <link rel="stylesheet" href="../schedule-css/jquery-ui-1.8.16.custom.css" type="text/css"/>
  <link rel="stylesheet" href="../schedule-css/examples.css" type="text/css"/>
  <style>
    .cell-title {
      font-weight: bold;
    }
...
<script src="../schedule-js/firebugx.js"></script>

<script src="../schedule-js/jquery-1.7.min.js"></script>
<script src="../schedule-js/jquery-ui-1.8.16.custom.min.js"></script>
<script src="../schedule-js/jquery.event.drag-2.2.js"></script>

<script src="../schedule-js/slick.core.js"></script>
<script src="../schedule-js/slick.formatters.js"></script>
<script src="../schedule-js/slick.editors.js"></script>
<script src="../schedule-js/slick.grid.js"></script>
<script src="../schedule-js/slick.dataview.js"></script>
